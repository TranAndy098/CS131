...
int x, y, i, j, grad_x, grad_y, grad;

#pragma omp parallel private(x,y,i,j, grad_x, grad_y, grad) shared(inputImage, outputImage, image_height, image_width, maskX, maskY) num_threads(8)
{
    #pragma omp for schedule(static, image_height/numChunks)
